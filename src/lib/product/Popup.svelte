...
<div class="md:p-5">
    ...
    <div class="flex text-center mt-10 gap-4 items-center justify-center">
        <!-- <a href={product.details?.href} target="_blank" class="p-2 bg-[#f8e5e6] transition-all ease-in-out hover:shadow-md duration-300 shadow-sm rounded-sm text-[#454545] uppercase no-underline text-sm">Vai al negozio</a> -->
